...
pub const options = [_]Opt{
    ...
    .{
        ...
        .required = false,
        .arg = .{ .name = "color256|truecolor", .default = "color256", .required = false, .type = .Text },
    },
    .{
        .long_name = "edges",
        .short_name = "e",
        ...
        .required = false,
        .arg = .{ .name = "sobel|LoG|DoG", .default = "sobel", .required = false, .type = .Text },
    },
    .{
        .long_name = "sigma",
        .short_name = null,
        ...
        .required = false,
        .arg = .{ .name = "float", .default = "1.0", .type = .Float },
    },
    .{
        .long_name = "time",
        .short_name = "t",
